...
if($_SESSION['id']){
	...
	$vuta = mysqli_fetch_assoc($x);
		$name = $vuta['regno'];
		$rn = "";
		if($vuta['gender'] == "Male" || $vuta['gender'] == "male"){
			$m = "SELECT * FROM boys_rooms WHERE bed_1='$name' or bed_2='$name' or bed_3='$name' or bed_4='$name'";
			$xm = mysqli_query($con,$m);
			$chumba = mysqli_fetch_assoc($xm);
			$rn = $chumba['room_no'];
		}else if($vuta['gender'] == "Female" || $vuta['gender'] == "female"){
			$m = "SELECT * FROM rooms WHERE bed_1='$name' or bed_2='$name' or bed_3='$name' or bed_4='$name'";
			$xm = mysqli_query($con,$m);
			$chumba = mysqli_fetch_assoc($xm);
			$rn = $chumba['room_no'];
		}
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">My Room: <?php echo $rn; ?></div>
