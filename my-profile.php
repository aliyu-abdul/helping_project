...
$query="update  reg set regno=?,firstname=?,middlename=?,lastname=?,gender=?,contact=?,updatedate=? where id=?";
...
Last Updation date : &nbsp; <?php echo $row->updatedate;?> 
</div>
...
<div class="col-sm-8">
<select name="gender" class="form-control" required="required" readonly>
...
<div class="col-sm-8">
<input type="text" name="contact" id="contact"  class="form-control" maxlength="10" value="<?php echo $row->contact;?>" required="required">
</div>
</div>
