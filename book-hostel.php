...
<div class="form-group">
<label class="col-sm-2 control-label">Campus Status</label>
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus" checked="checked">In Campus 
<input type="radio" value="1" name="foodstatus"> Off Campus
</div>
</div>	
...
<div class="col-sm-8">
<input type="text" name="regnoo" id="regnoo"  class="form-control" value="<?php echo $row->regno;?>" readonly >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="contact" id="contact" value="<?php echo $row->contact;?>"  class="form-control" readonly>
</div>
</div>
