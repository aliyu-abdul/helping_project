...
if(isset($_GET['yess']))
{
	if($_GET['yess'] == true){
		$idd=$_GET['id'];
		$x = "UPDATE `accommodation` SET keyy='no' where id='$idd' ";
		mysqli_query($con,$x) or die(mysqli_error($con));
...
{
$idd=$_GET['id'];
$msg=mysqli_query($con,"UPDATE accommodation SET keyy='yes' where id='$idd'");
if($msg)
{
