...
$stmt=$mysqli->prepare("SELECT regno,password,id FROM reg WHERE regno=? and password=? ");
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="text" placeholder="Eg T/UDOM/2016/06219" name="regno" class="form-control mb">
